...
|---|---|
| `Paper_ID` | Stable project identifier for a source paper (currently P001-P022); the outer provenance and leave-one-paper-out grouping unit. New primary sources beyond the original P001-P019 set receive the next stable ID after DOI/source-identity and duplicate review. |
...
**Post-V16 status:** this section records the frozen V12 design and its counts; it is retained for reproducibility but is stale after P002 recovery V13 and the P020/P021/P022 extensions. No candidate, manifest, M2 completeness statistic, group-support result, or four-state count below may be used as current V16 evidence until Global QC, coverage/schema statistics, and grouped split feasibility are refreshed. V16 includes the P021 Fe50Mn17.5Cr12.5Co10Ni5Si5 family and five P022 chemistry variants within one strict P022 study group; no frozen V12 split artifact has been edited to accommodate them.
...
| ISS-005 | Small and imbalanced independent target classes. | Limits stable training, calibration, subgroup evaluation, and performance claims. | P1 | OPEN | V16 has 31/4 TRIP and 29/5 TWIP positive/negative conditions. P022 adds one TRIP positive and three TWIP positives but no negative-family or joint support. V12 group-support and M2 figures are stale; refresh them only after the current collection batch. Expand diverse independent negatives without fabrication or resampling. |
| ISS-006 | Extended recovery V16 replacement-aware counting identifies 62 independent experimental ML conditions, with only 35 TRIP-labelled, 34 TWIP-labelled, and 28 jointly labelled. | Effective sample size remains small despite 227 observation/support rows. | P1 | OPEN | P022 contributes five exact independent conditions, but C4 remains fully unresolved and every P022 condition lacks at least one target component. V12 split candidates cannot be reused as current; rerun Global QC, coverage/schema statistics, and grouped split design before matrix construction. |
| ISS-007 | V12 reported grain size as 56.12% missing; V13 added scoped P002 sizes, V14 added an approximately 40 um P020 FCC-average size, and V15 added exact P021 10.0/19.5/40.9/149.6 um states with twin-boundary exclusion scope. P022 provides qualitative dendrite morphology but no numeric grain size. | Important microstructure dependence may be omitted or selection-biased. | P2 | OPEN | Refresh V16 coverage after collection; retain phase/RZ/NRZ/full-average and twin-boundary-exclusion definitions instead of merging scopes, and keep P022 numeric grain size NA without figure digitization. |
| ISS-008 | V12 reported SFE as 75.51% missing and methods are heterogeneous; V13 recovers P002 approximately 14 mJ/m2 at 300 K only as a thermodynamic estimate, P020 remains NA, P021 contributes only an author-inferred raw `<23 mJ/m2` upper bound, and P022 has qualitative C/Mo directions plus secondary general thresholds only. | Sparse/method-confounded phase-stability descriptor. | P2 | OPEN | Keep P021/P022 numeric SFE NA where direct values are absent; general P022 thresholds are support-only and never condition values. Preserve method/temperature/paper scope, refresh coverage later, and perform no imputation or cross-paper transfer. |
| ISS-009 | V12 reported DeltaG as 92.86% missing; V13 recovers P002 `-292 J/mol` at 300 K by Thermo-Calc TCFE7, while P020, P021, and P022 remain NA. | Phase-stability modelling is poorly supported. | P2 | OPEN | Refresh V16 coverage later and retain sign, temperature, CALPHAD method, alloy, and paper scope; never calculate or transfer P020/P021/P022 DeltaG. |
| ISS-010 | V12 initial FCC/HCP coverage is stale. V13 establishes qualitative single FCC/direct HCP=0 for three P002 conditions; V14 adds direct P020 initial FCC/HCP 0.79/0.21; V15 adds five single-FCC P021 states with HCP=0 and pre-test safeguards; V16 adds P022 C0 FCC+HCP with unknown fractions plus four XRD single-FCC(-matrix) states with HCP=0, direct C4 carbides, and qualitative dendrite morphology. | Initial state can be confused with deformation-induced transformation or tensile twinning, and a matrix phase description can obscure secondary phases. | P2 | OPEN | Refresh V16 coverage while preserving missing FCC fractions, C0 pre-existing HCP timing, C4 carbide/XRD coexistence, and P022 qualitative-only morphology. Initial HCP never establishes deformation-induced TRIP. |
...
| ISS-013 | Mechanical outcomes and post-deformation descriptors could create feature leakage. | Models could predict labels using consequences of the mechanism. | P1 | RESOLVED_ARCHITECTURALLY / V16 REFRESH REQUIRED | Feature Schema V1 freezes the pre-tensile rule for 343 V12 fields. V16 has 524 columns; P022 approximate UTS/elongation and 40%-strain EBSD twins are explicitly mechanical-outcome/target evidence, while P021 post-test HCP/alpha-BCT and Hall-Petch fields retain their leakage classes. Inventory and coverage must be regenerated before use. |
| ISS-014 | No final target or final ML-ready dataset exists. | Model comparison/publication claims would be premature. | P1 | OPEN | P022 V16 adds no jointly labelled condition and joint `00` remains absent. V12 Feature Schema coverage and Grouped Split Design V1 are historical only and do not include P002/P020/P021/P022 changes. Refresh QC/coverage/schema/splits after collection before any matrix; no model may yet be trained. |
...
|---:|---|---|
| 1 | Data extraction | IN PROGRESS: the original 19-paper extraction is preserved; P020, P021, and P022 form the verified extended-source recovery set beyond P019. |
| 2 | QC and provenance | IN PROGRESS: V12 global QC remains preserved; P002 V13, P020 V14, P021 V15, and P022 V16 add field-level provenance. V16 Global QC and coverage refresh remain required after the current source-collection batch. |
| 3 | Hierarchical experimental identity | IMPLEMENTED WITH CONSERVATIVE FALLBACKS: V16 has 62 replacement-aware conditions. P022 adds five separately fabricated chemistry variants under one strict series and five material parents; three 40%-strain EBSD observations remain correlated children. Physical-batch and replicate metadata remain NA. The full V16 index must be regenerated. |
| 4 | Target verification | IN PROGRESS: operational definitions and queue exist; source verification incomplete. |
| 5 | Targeted literature expansion | IN PROGRESS: P020, P021, and P022 are the first three new verified primary experimental papers beyond P001-P019; additional collection may continue before global refresh. |
...
| 9 | Grouped/external validation | V12 SPLIT DESIGN V1 PRESERVED BUT STALE FOR V16: P002/P020/P021/P022 changed target support, joint `00` remains zero, and P022 adds five siblings within one strict study but five material parents. Rerun grouped feasibility after collection and before matrix construction. No model validation or performance result has occurred. |
...
|---|---|
| Current stage | P022 scientific evidence recovery V16 is complete as the third verified new-source extension beyond P019. V12 Global QC, Feature Schema V1 coverage, and Grouped Split Design V1 remain preserved historical artifacts but are stale for V16. No ML training, feature transformation, or performance evaluation has occurred. |
| Current canonical dataset | `data/interim/master_19papers_hierarchical_ids.csv` |
| Current recovery source dataset | `data/processed/master_extended_recovery_v16.csv` (227 rows, 524 columns; all 219 V15 rows and all 497 V15 columns cell-preserved) |
| Current global-QC dataset | `data/processed/master_19papers_recovery_v12_qc.csv` remains the last completed QC artifact, but it does not assess P002 V13, P020 V14, P021 V15, or P022 V16 and is not current for the 227-row extended dataset. |
| Current feature schema | Feature Schema V1 remains the frozen V12 prediction-time policy and classifies 343 V12 fields. V16 has 524 columns; P022 raw atomic-ratio chemistry, missing-test controls, initial phase/carbide/morphology fields, author/direct target-evidence grades, mechanical outcomes, 40%-strain stage evidence, and SFE/DeltaG safeguards require a non-destructive refresh without weakening the pre-tensile rules. |
| Current grouped split design | Grouped Split Design V1 remains a reproducible V12 artifact only. V16 has changed usable support, lacks joint `00`, and adds five P022 material parents within one strict P022 study group; no V1 candidate or manifest is a current V16 split. |
| Frozen prediction moment | Pre-deformation condition-level mechanism prediction, immediately before tensile loading begins. |
| Proposed feature-family progression | The V12 M1-M5 hierarchy and M2 baseline focus remain intended policy, but candidate counts and complete-case support are stale after V16. No transformed matrix exists. |
| Number of papers | 22 primary source IDs in the extended recovery dataset: original P001-P019 plus new P020, P021, and P022. |
| Number of rows | 227: the immutable 219-row V15 prefix plus five P022 independent conditions and three correlated 40%-strain EBSD children; no replicate rows were added. |
| Latest independent-condition estimate | 62 replacement-aware experimental ML conditions. P022 contributes five exact conditions; its three stage children do not count. The twelve P017 computational conditions remain separate and unchanged. A refreshed V16 condition index is required after collection. |
| Current target status | Under review. V16 usable conditions are TRIP 35 (31/4), TWIP 34 (29/5), and joint 28 (`10=5`, `01=4`, `11=19`, `00=0`). P022 adds one medium author-attributed TRIP positive and three direct EBSD TWIP positives, but no negative or joint-labelled condition. Group-level and M2-complete support are not refreshed. |
| Major unresolved issue | Independent negative support remains only 4 TRIP and 5 TWIP, joint `00` remains absent, and 34 conditions have at least one unresolved target component. P022 measured bulk chemistry, physical batch/replicate metadata, exact numeric test temperature/rate, exact FCC fractions, numeric grain sizes, multiple opposite-target components, numeric SFE, and DeltaG remain unresolved; global descriptors remain sparse. Paper/material dependence and stale V12 QC/schema/split statistics block matrix construction or confirmatory claims. |
| Next action | Continue verified new-paper recovery if the collection batch is still open. When collection pauses, run a non-destructive V16 Global QC refresh, then refresh feature coverage/schema statistics and redesign grouped T1/T2/T3 splits with P020/P021/P022/common-family controls. Do not train, impute, encode, normalize, resample, synthesize, reconcile chemistry, or calculate alloy descriptors yet. |
