...
|---|---|
| `Paper_ID` | Stable project identifier for a source paper (currently P001–P021); the outer provenance and leave-one-paper-out grouping unit. New primary sources beyond the original P001–P019 set receive the next stable ID after DOI/source-identity and duplicate review. |
...
**Post-V15 status:** this section records the frozen V12 design and its counts; it is retained for reproducibility but is stale after P002 recovery V13 and the P020/P021 extensions. No candidate, manifest, M2 completeness statistic, group-support result, or four-state count below may be used as current V15 evidence until Global QC, coverage/schema statistics, and grouped split feasibility are refreshed. V15 adds the new `Fe50Mn17.5Cr12.5Co10Ni5Si5` material family with five siblings in one strict study group; no frozen V12 split artifact has been edited to accommodate it.
...
| ISS-005 | Small and imbalanced independent target classes. | Limits stable training, calibration, subgroup evaluation, and performance claims. | P1 | OPEN | V15 has 30/4 TRIP and 26/5 TWIP positive/negative conditions. P021 adds two TRIP positives and one TWIP/joint positive but no negative-family support. V12 group-support and M2 figures are stale; refresh them only after the current collection batch. Expand diverse independent negatives without fabrication or resampling. |
| ISS-006 | Extended recovery V15 replacement-aware counting identifies 57 independent experimental ML conditions, with only 34 TRIP-labelled, 31 TWIP-labelled, and 28 jointly labelled. | Effective sample size remains small despite 219 observation/support rows. | P1 | OPEN | P021 contributes five exact independent conditions, but three RT states remain fully unresolved and the 77 K state remains TWIP-unresolved. V12 split candidates cannot be reused as current; rerun Global QC, coverage/schema statistics, and grouped split design before matrix construction. |
| ISS-007 | V12 reported grain size as 56.12% missing; V13 added scoped P002 sizes, V14 added an approximately 40 um P020 FCC-average size, and V15 adds exact P021 10.0/19.5/40.9/149.6 um states with twin-boundary exclusion scope, but global coverage is not refreshed. | Important microstructure dependence may be omitted or selection-biased. | P2 | OPEN | Refresh V15 coverage after collection; retain phase/RZ/NRZ/full-average and twin-boundary-exclusion definitions instead of merging scopes. |
| ISS-008 | V12 reported SFE as 75.51% missing and methods are heterogeneous; V13 recovers P002 approximately 14 mJ/m2 at 300 K only as a thermodynamic estimate, P020 remains NA, and P021 contributes only an author-inferred raw `<23 mJ/m2` upper bound plus qualitative 77 K reduction. | Sparse/method-confounded phase-stability descriptor. | P2 | OPEN | Keep P021 numeric SFE NA and the raw bound ineligible as direct numeric SFE; preserve method/temperature/paper scope, refresh coverage later, and perform no empirical imputation or cross-paper transfer. |
| ISS-009 | V12 reported DeltaG as 92.86% missing; V13 recovers P002 `-292 J/mol` at 300 K by Thermo-Calc TCFE7, while P020 and P021 remain NA. | Phase-stability modelling is poorly supported. | P2 | OPEN | Refresh V15 coverage later and retain sign, temperature, CALPHAD method, alloy, and paper scope; never calculate or transfer P020/P021 DeltaG. |
| ISS-010 | V12 initial FCC/HCP coverage is stale. V13 establishes qualitative single FCC/direct HCP=0 for three P002 conditions; V14 adds direct P020 initial FCC/HCP 0.79/0.21; V15 adds five fully recrystallized single-FCC P021 states with HCP=0, alpha-BCT=0, exact FCC fraction NA, annealing twins, and a condition-specific 77 K pre-test stacking-fault state. | Initial state can be confused with deformation-induced transformation or tensile twinning. | P2 | OPEN | Refresh V15 coverage while preserving pre-test timing and missing FCC fractions. Annealing twins and pre-test stacking faults never establish TWIP; post-test HCP fractions remain target evidence only. |
...
| ISS-013 | Mechanical outcomes and post-deformation descriptors could create feature leakage. | Models could predict labels using consequences of the mechanism. | P1 | RESOLVED_ARCHITECTURALLY / V15 REFRESH REQUIRED | Feature Schema V1 freezes the pre-tensile rule for 343 V12 fields. V15 has 497 columns; P021 YS/UTS/elongation, 0.149/0.562 post-fracture HCP fractions, alpha-BCT pathway status, and Hall-Petch fit are explicitly outcome/target/model-derived leakage. Inventory and coverage must be regenerated before use. |
| ISS-014 | No final target or final ML-ready dataset exists. | Model comparison/publication claims would be premature. | P1 | OPEN | P021 V15 raises joint `11` support but joint `00` remains absent. V12 Feature Schema coverage and Grouped Split Design V1 are historical only and do not include P002/P020/P021 changes. Refresh QC/coverage/schema/splits after collection before any matrix; no model may yet be trained. |
...
|---:|---|---|
| 1 | Data extraction | IN PROGRESS: the original 19-paper extraction is preserved; P020 and P021 form the verified extended-source recovery set beyond P019. |
| 2 | QC and provenance | IN PROGRESS: V12 global QC remains preserved; P002 V13, P020 V14, and P021 V15 add field-level provenance. V15 Global QC and coverage refresh remain required after the current source-collection batch. |
| 3 | Hierarchical experimental identity | IMPLEMENTED WITH CONSERVATIVE FALLBACKS: V15 has 57 replacement-aware conditions. P021 adds five exact siblings under one new material parent/strict series, with Replicate_n=3 as minimum aggregate metadata and no replicate rows; unknown physical batch/replicate identities remain NA. The full V15 index must be regenerated. |
| 4 | Target verification | IN PROGRESS: operational definitions and queue exist; source verification incomplete. |
| 5 | Targeted literature expansion | IN PROGRESS: P020 and P021 are the first two new verified primary experimental papers beyond P001-P019; additional collection may continue before global refresh. |
...
| 9 | Grouped/external validation | V12 SPLIT DESIGN V1 PRESERVED BUT STALE FOR V15: P002/P020/P021 changed target support, joint `00` remains zero, and P021 adds five siblings in a new strict source/material family. Rerun grouped feasibility after collection and before matrix construction. No model validation or performance result has occurred. |
...
| Item | Current snapshot (2026-08-28) |
|---|---|
| Current stage | P021 scientific evidence recovery V15 is complete as the second verified new-source extension beyond P019. V12 Global QC, Feature Schema V1 coverage, and Grouped Split Design V1 remain preserved historical artifacts but are stale for V15. No ML training, feature transformation, or performance evaluation has occurred. |
| Current canonical dataset | `data/interim/master_19papers_hierarchical_ids.csv` |
| Current recovery source dataset | `data/processed/master_extended_recovery_v15.csv` (219 rows, 497 columns; all 214 V14 rows and all 454 V14 columns cell-preserved) |
| Current global-QC dataset | `data/processed/master_19papers_recovery_v12_qc.csv` remains the last completed QC artifact, but it does not assess P002 V13, P020 V14, or P021 V15 and is not current for the 219-row extended dataset. |
| Current feature schema | Feature Schema V1 remains the frozen V12 prediction-time policy and classifies 343 V12 fields. V15 has 497 columns; P021 initial-state fields, target/evidence fields, mechanical outcomes, post-test HCP/alpha-BCT fields, inferred-SFE controls, Hall-Petch support, and all coverage statistics require a non-destructive refresh without weakening the pre-tensile rules. |
| Current grouped split design | Grouped Split Design V1 remains a reproducible V12 artifact only. V15 has changed usable support, lacks joint `00`, and adds five P021 sibling conditions in a new Fe50Mn17.5Cr12.5Co10Ni5Si5 strict family; no V1 candidate or manifest is a current V15 split. |
| Frozen prediction moment | Pre-deformation condition-level mechanism prediction, immediately before tensile loading begins. |
| Proposed feature-family progression | The V12 M1-M5 hierarchy and M2 baseline focus remain intended policy, but candidate counts and complete-case support are stale after V15. No transformed matrix exists. |
| Number of papers | 21 primary source IDs in the extended recovery dataset: original P001-P019 plus new P020 and P021. |
| Number of rows | 219: the immutable 214-row V14 prefix plus five exact P021 independent tensile conditions; no P021 child or replicate rows were added. |
| Latest independent-condition estimate | 57 replacement-aware experimental ML conditions. P021 contributes five exact conditions. The twelve P017 computational conditions remain separate and unchanged. A refreshed V15 condition index is required after collection. |
| Current target status | Under review. V15 usable conditions are TRIP 34 (30/4), TWIP 31 (26/5), and joint 28 (`10=5`, `01=4`, `11=19`, `00=0`). P021 adds two direct TRIP positives and one low-abundance direct TWIP/joint positive; it adds no negative support. Group-level and M2-complete support are not refreshed. |
| Major unresolved issue | Independent negative support remains only 4 TRIP and 5 TWIP, joint `00` remains absent, and 29 conditions have at least one unresolved target component. P021 measured bulk chemistry, physical batch/replicate identities, three RT mechanism states, 77 K TWIP, numeric SFE, and DeltaG remain unresolved; global descriptors remain sparse. Paper/material dependence and stale V12 QC/schema/split statistics block matrix construction or confirmatory claims. |
| Next action | Continue verified new-paper recovery if the collection batch is still open. When collection pauses, run a non-destructive V15 Global QC refresh, then refresh feature coverage/schema statistics and redesign grouped T1/T2/T3 splits with P020/P021/common-family controls. Do not train, impute, encode, normalize, resample, synthesize, reconcile chemistry, or calculate alloy descriptors yet. |
